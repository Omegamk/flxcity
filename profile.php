               ...
               <div class="row">
                  	<div class="col-sm-12 col-md-5 col-lg-4">
	                    <div class="freelancer-profile-sidebar">
                             <div class="profile-img">
                                   <img src="./img/user/user1.jpg" class="img-fluid rounded-circle " alt="">
                                </div>
	                        ...
	                        <div class="profile-info">
                               ...
                               <div class="work-experince d-flex justify-content-between px-3">
                                        <span><i class="fa fa-briefcase" aria-hidden="true"></i> Work Experince </span>
                                        <span>3 Years</span>
                                    </div>
                                    <hr>
                                ...
                                <div class="profile-skills py-2">
                                    <h3 class="py-2">Skills</h3>
                ...
                <div class="profile-posts">
                    ...
                    <div class="d-block d-lg-flex justify-content-around">
						...
						<div class="col-md-4 categories-card-details m-2 p-0 ">
							<div class="cards-img">
